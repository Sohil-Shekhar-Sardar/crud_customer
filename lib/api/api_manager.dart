...
class APIManager {
  ...
  // GET
  Future<dynamic> getAPICall({required String url, bool isLoaderShow = true, int timeOut = 100}) async {
    var responseJson;
  ...
  // POST
  Future<dynamic> postAPICall({required String url, required var params, bool isLoaderShow = true, int timeOut = 100}) async {
    var responseJson;
